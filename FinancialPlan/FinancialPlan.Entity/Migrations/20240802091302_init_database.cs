...
namespace FinancialPlan.Entity.Migrations
{
    public partial class init_database : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AnnualReportDetails",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AnnualReportId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DepartmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TotalExpense = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BiggestExpenditure = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnualReportDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnnualReportDetails_AnnualReports_AnnualReportId",
                        column: x => x.AnnualReportId,
                        principalTable: "AnnualReports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnnualReportDetails_Departments_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnualReportDetails_AnnualReportId",
                table: "AnnualReportDetails",
                column: "AnnualReportId");

            migrationBuilder.CreateIndex(
                name: "IX_AnnualReportDetails_DepartmentId",
                table: "AnnualReportDetails",
                column: "DepartmentId");
